...
export default function DashboardHome() {
  ...
  const getCertificate = useGemstoneStore(
    (state) => state.getCertificateByGemstoneId,
  );
    ...
    <div className="space-y-12">
      ...
      <header className="pb-8 border-b border-white/[0.06]">
        ...
        <p className="text-smoke text-sm">
          Manage your gemstone collection and 360° models
        </p>
      </header>
      ...
      <section>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          <div className="p-6 bg-carbon border-l-2 border-white/20 border-t border-r border-b border-white/[0.06]">
            <div className="text-xs font-medium text-smoke uppercase tracking-wider mb-2">
              Total Gems Uploaded
            </div>
            <div className="font-serif text-5xl font-light text-white mb-2">
              {stats.totalGems}
            </div>
                ...
                return (
                  ...
                  >
                    <td className="px-6 py-6 border-b border-white/[0.04]">
                      <div
                        className={`w-14 h-14 bg-slate border border-white/10 flex items-center justify-center relative overflow-hidden`}
                        style={{
                    ...
                    <td className="px-6 py-6 border-b border-white/[0.04]">
                      ...
                      <div className="text-sm text-smoke">
                        {gem.weight} ct · {gem.cut}
                      </div>
                    </td>
                    <td className="px-6 py-6 border-b border-white/[0.04]">
                      <span
                        className={`inline-block px-3 py-1 text-xs font-medium uppercase tracking-wide border ${
