...
export default function UploadGemstone({ onComplete }: UploadGemstoneProps) {
  ...
  const {
    getRootProps: getCertRootProps,
    getInputProps: getCertInputProps,
    isDragActive: isCertDragActive,
  } = useDropzone({
  ...
  return (
    <div className="max-w-5xl space-y-10">
      ...
      <header className="pb-6 border-b border-gray-light/50">
        <h1 className="font-serif text-4xl text-charcoal mb-2 tracking-tight">
          Upload Gemstone
        </h1>
        <p className="text-gray-warm text-sm">
          Upload 360° rotation frames and certificate to create a complete
          gemstone entry
        </p>
      </header>
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setGemData({ ...gemData, origin: e.target.value })
              }
          ...
          <div className="col-span-2">
            ...
            <input
              ...
              onChange={(e) =>
                setGemData({ ...gemData, colorGrade: e.target.value })
              }
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-cool">
              JPG, PNG • More frames = smoother rotation (recommended: 36-72
              frames)
            </div>
          </div>
        </div>
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between p-4 bg-cream/30 rounded-lg border border-gray-light/50 mb-4">
              <div className="flex gap-8">
                ...
                <div>
                  ...
                  <span
                    className={`ml-2 text-sm font-semibold ${imageFiles.length >= 36 ? "text-gemstone-emerald" : imageFiles.length >= 12 ? "text-gemstone-topaz" : "text-gray-warm"}`}
                  >
                    {imageFiles.length >= 36
                      ? "✓ Ready"
                      : `Need ${36 - imageFiles.length} more`}
                  </span>
                </div>
              </div>
              <button
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {imageFiles.map((file, index) => (
                <div
                  key={index}
                  className="relative w-20 h-20 flex-shrink-0 bg-cream rounded-lg border border-gray-light overflow-hidden"
                >
                  <img
        ...
        <div className="grid grid-cols-2 gap-5 mb-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setCertData({ ...certData, certificateNumber: e.target.value })
              }
      ...
      <section className="bg-white rounded-xl border border-gray-light/50 p-6">
        ...
        <p className="text-sm text-gray-warm mb-6">
          Choose which information appears on the shareable public link
        </p>
        <div className="grid grid-cols-2 gap-4">
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({
                  ...visibility,
                  showCustomerContact: e.target.checked,
                })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({
                  ...visibility,
                  showCustomerEmail: e.target.checked,
                })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({ ...visibility, showName: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
            <span className="text-sm font-medium text-charcoal">
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({ ...visibility, showType: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({ ...visibility, showCut: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({ ...visibility, showClarity: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
            <span className="text-sm font-medium text-charcoal">
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({
                  ...visibility,
                  showColorGrade: e.target.checked,
                })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({ ...visibility, showOrigin: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
            <span className="text-sm font-medium text-charcoal">
          ...
          <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-cream/30 cursor-pointer transition-all">
            <input
              ...
              onChange={(e) =>
                setVisibility({
                  ...visibility,
                  showCertificate: e.target.checked,
                })
              }
              className="w-5 h-5 rounded border-gray-light text-gold focus:ring-gold focus:ring-offset-0"
            />
