    ...
    <div className="min-h-screen bg-pearl flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white border border-gray-light/50 rounded-2xl p-8 shadow-sm space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-warm">Sign in to access dashboard and settings.</p>
          <p className="text-xs text-gray-warm mt-2">Custom login: username admin, password Admin@12345</p>
        </div>

        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-charcoal mb-2">Username or Email</label>
            <input
              type="text"
              value={identifier}
